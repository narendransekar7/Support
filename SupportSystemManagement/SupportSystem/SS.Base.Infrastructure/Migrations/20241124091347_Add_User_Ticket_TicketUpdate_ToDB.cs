...
{
    /// <inheritdoc />
    public partial class Add_User_Ticket_TicketUpdate_ToDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketLogs", x => x.LogId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResolutionDueDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketUpdates", x => x.UpdateId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketUpdates_Users_UpdatedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketUpdates_UpdatedBy",
                table: "TicketUpdates",
                column: "UpdatedBy");
        }
